...
{
    public class InativarUsuarioHandler : IRequestHandler<CommandUsuario, Response>
    {
        private readonly UsuarioRepositorio _repositorio;
        private readonly UnityOffWork _unityOffWork;

        public InativarUsuarioHandler(UsuarioRepositorio repositorio, UnityOffWork unityOffWork) {
        ...
        public async Task<Response> Handle(CommandUsuario request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                return new Response {Message = "Usuário Inativado com sucesso", StatusCode = 200};
            }
