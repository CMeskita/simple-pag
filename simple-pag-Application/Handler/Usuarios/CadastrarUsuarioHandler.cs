...
{
    public class CadastrarUsuarioHandler : IRequestHandler<CommandUsuario, Response>
    {
        ...
        public CadastrarUsuarioHandler(IUsuarioRepositorio repositorio, IUnityOffWork unityOffWork)
        {
